...
let kulerPicker = {
    ...
    load: function(canvas) {
        kulerPicker.canvas = canvas,
        kulerPicker.context = canvas.getContext("2d"),
        ...
        canvas.width = kulerPicker.size, 
        canvas.height = kulerPicker.size, 
